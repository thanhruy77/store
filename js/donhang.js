document.addEventListener("DOMContentLoaded", function () {
    ...
    if (danhsachdonhang && danhsachdonhang.length > 0) {
        danhsachdonhang.forEach(function (donhang) {
            ...
            xacnhanButton.textContent = 'Xác nhận';
            ...
            xacnhanButton.addEventListener('click', function () {
                ...
                if (confirm("Bạn có chắc chắn muốn xác nhận đơn hàng này không?")) {
                    ...
                    if (danhsachdonhang[index].xacnhan !== "Đã xác nhận") {
                        danhsachdonhang[index].xacnhan = "Đã xác nhận";
                        ...
                        var dsgiaohangxacnhan = localStorage.getItem('dsdonhangxacnhan') ? JSON.parse(localStorage.getItem('dsdonhangxacnhan')) : [];
                        dsgiaohangxacnhan.push(donhangxacnhan);
                        localStorage.setItem('dsdonhangxacnhan', JSON.stringify(dsgiaohangxacnhan));
                        ...
                        alert("Đơn hàng này đã được xác nhận trước đó!");
                    }
                }
            });
